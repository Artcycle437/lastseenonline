...
"NAME": "Deutsch",
  ...
  "UNZIPPER_TEXT": "Diese ZIP file ist mit einem 4 stelligen Code passwort-gesichert.",
  ...
  "LAWSON_CHATLOG": [
    "<LAWSON>: heyyy :) Wie war dein Tag?",
    "<LIZ>: War gut",
    "<LAWSON>: Nur gut?? Was machst du gerade?",
    "<LIZ>: Nicht viel!! Nur bisschen Musik hören Spiele spielen... Was ist mit dir??",
    "<LAWSON>: Auch nur gut hier... muss noch für den Algebra Test lernen, ansonsten bringt mich meine Mutter uuum",
    "<LIZ>: omg hat deine Mutter dich nicht letztes mal angeschiern?",
    "<LAWSON>: JA... aber ich glaube ich mache es dieses mal besser",
    "<LIZ>: :((( Du gibst dein bestes!! Lass den Kopf nicht hängen. Meine Mom ist gerade auch nicht so gut drauf...",
    "<LAWSON>: Deine auch??? Erzähl's mir!!",
    "<LIZ>: Sie sagt mir die ganze Zeit, dass ich zu sehr wie mein Dad bin... es ist aber nicht meine Schuld, dass er sie verlassen hat...Jeden Tag ist es nur Geschrei und Geschrei... Ich bin nicht gut genug.",
    "<LAWSON>: aww das ist hart... ja, es ist auch schon eine Weile her das ich meinen Dad gesehen habe... ich frage mich wie es ihm geht...",
    "<LAWSON>: Ich muss jetzt los, hab es wirklich gemocht mit dir zu sprechen, gn!!",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Ey hast du algebra HW schon?",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Heyy es gibt einpaaar Gerüchte an der Schule, geht es dir gut?",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Ich weiß das du nicht darüber reden willst aber ich will nur sicher gehen das es dir gut geht",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Vermisse dich...",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Ich habe gerade eine 3+ in meinem algebra test bekommen :(",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Ich habe heute mit meiner Mutter gestritten, es ist okay... hoffe es geht dir gut.",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetzt online",
    "<LAWSON>: Bin gerade in unsere Traum Schule gekommen! <3",
    "<SYSTEM>: aznL4ws0n ist jetzt offline",
    "<SYSTEM>: aznL4ws0n ist jetz online",
    "<LAWSON>: Hab gerade einen HUnd gesehen der ein bisschen wie scotty ausgesehen hat :)",
    "<SYSTEM>: aznL4ws0n ist jetz offline"
  ],
  "SCOTT_CHATLOG": [
    "<SCOTT>: Hallo. Hier ist scott von Other World. Addest du mich?",
    "<LIZ>: JA!!!(=^o^=) So worüber du geredet hast. Das Ritual... ich habe darüber nachgedacht. Wird es mir helfen wegzugehen?",
    "<SCOTT>: ah genau. Das Baphomet Ritual. Ich würde es mehr als den Konami Code des Universums bezeichnen. Es wird dir nicht helfen wegzugeh, aber es wird dein Bewusstsein... deinen Code... in die Erleuchtung bringen. Ich kann dir die Ewigkeit zeigen",
    "<LIZ>: hmm ok nebenbei, du hast den gleichen namen wie mein Hund hahahahah",
    "<SYSTEM>: scottNJ ist jetzt offline",
    "<SYSTEM>: scottNJ ist jetzt online",
    "<SCOTT>: Hast du meinen Link vom Spiel bekommen?",
    "<LIZ>: Das ist es??? bist du sicher das es funktioniert???",
    "<SCOTT>: Du bist die, die mich um Hilfe gebeten hat. Der Weg zur ewigen Heiligkeit liegt hier. Suchst du ewige Glücklichkeit oder nicht?",
    "<SYSTEM>: scottNJ ist jetzt offline",
    "<SYSTEM>: scottNJ ist jetzt online",
    "<SCOTT>: Der Prozess hat begonnen, bist du bereit?",
    "<LIZ>: ja... aber ich habe etwas Angst",
    "<SCOTT>: Hab keine Angst Kleine.Ich werde dich bald treffen",
    "<SYSTEM>: scottNJ ist jetzt offline",
    "<SYSTEM>: scottNJ ist jetzt online",
    "<LIZ|CORRUPTED>: DU HAST MIR VERSPOCHEN MICH NICHT ZU VERLASSEN"
  ],
  "ETERNALJUICE_CHATLOG": [
    "<ETERNAL_JUICE>: a/s/l?",
    "<LIZ>: Ich bin gerade mal 14",
    "<ETERNAL_JUICE>: Der süße Nekat der Jugend. Ich kann es kaum erwarten das du uns anschließt",
    "<LIZ>: was???"
  ],
  "EMMBER_CHATLOG": [
    "<LIZ>: aaahhh Lawson ist soooo süß :(:(:(:(:(",
    "<EMMBER>: Warum fragst du ihn nicht einfach aus!!!",
    "<LIZ>: Es ist unmöglich, dass er mich mag... Ich bin nicht schön",
    "<EMMBER>: Was lol!! Du bist so schön......",
    "<LIZ>: =.= Meine Momm sagt, dass ich nicht ihre Nase hab. Ich hab die große Nase meines Dads.! Ich hasse es.",
    "<EMMBER>: Hör nicht auf sie. Du bist wuuUunderschön d(^_^)z",
    "<LIZ>: Ich will einfach wewglaufen emmmm... Ich hassse es auf der Erde",
    "<EMMBER>: awww Auch wenn Lawson dich nicht liebt. Ich werde dich immer lieben!!! BFF!!!",
    "<SYSTEM>: xXemmberXx86 ist jetzt offline",
    "<SYSTEM>: xXemmberXx86 ist jetzt online",
    "<LIZ>: Meine Mom hat meinen Computer weggenommen, aber ich habe einen Weg gefunden em.",
    "<EMMBER>: sozz Hab grad gelernt, was ist passiert?? Deine Mom ist so weird!!",
    "<SYSTEM>: xXemmberXx86 ist jetzt offline",
    "<SYSTEM>: xXemmberXx86 ist jetzt online",
    "<EMMBER>: liz, wir haben seit guten 2 Wochen nicht mehr geredet, Was hast du so gemacht??",
    "<LIZ>: o soz!! Habe nur mit einpaar Freunden aus Other World rumgehongen!!",
    "<SYSTEM>: xXemmberXx86 ist jetzt offline",
    "<SYSTEM>: xXemmberXx86 ist jetzt online",
    ...
    "<EMMBER>: yeah die ZIP file?Aber sie hat einen 4 stelligen Code but it's got a 4-digit passcode.",
    "<LIZ>: -_- Es sind 4 meiner Songs auf meiner LoseAmp Playlist its 4 of my songs on my LoseAmp playlist!!",
    "<EMMBER>: oh... Ich checks nicht... du hast 8 songs.",
    "<LIZ>: Benutzt du noch unseren BFF <b>desktop Hintergrund</b>??Du alle Fenster schließen außer den vom LoseAmp!!! Der Hintergrund zeigt dir die Reihenfolge.",
    "<EMMBER>: O_O !! Das crazy!! omg <b>Ich habe gerade das LoseAmp Fenster drüber geschoben.</b> ok was jetzt??",
    "<LIZ>: Hör dir den Text an!!",
    "<EMMBER>: ooooOOo Jetzt bist du schlau wie scheiße ^_^",
    "<EMMBER>: omg Warum hast du ein pic von Lawsony??",
    "<LIZ>: NOOOo DAS WAR EIN VERSEHEN!!!",
    "<EMMBER>: ... Das sind komische Bilder...",
    "<LIZ>: so du bist interresiert?",
    "<SYSTEM>: xXemmberXx86 ist jetzt offline",
    "<SYSTEM>: xXemmberXx86 ist jetzt online",
    "<LIZ|CORRUPTED>: EMILY ES HAT FUNKTIONIERT",
    "<EMMBER>: Wer ist das?",
    "<LIZ|CORRUPTED>: ICH BIN'S LIZ!! ICH LERNE IMMERNOCH WIE ICH DAS HIER KONTROLLIEREN KANN",
    "<EMMBER>: hör zu, Ich weiß nicht was für ein beschißener, kranker Witz ist den du hier spielst, aber es ist eicht fucked up. Ich blockiere dich."
  ],
  "ORION_CHATLOG": [
    "<LIZ>: Hey, hast du Jennis neue Welt gesehen??",
    "<ORION>: yah Die war so cool. Sie hat sich wirklich ins Zeug gelegt.",
    "<LIZ>: Eines Tages werde ich eine genau so coole Welt machen",
    "<ORION>: haha vielleicht",
    "<ORION>: oh ja, sie dir an was ich gefunden habe: RED_HERRING_EXE",
    "<LIZ>: oh wow?? Ist das von other world???",
    "<ORION>: Nein, ist bloß ein Kunst Projekt. Glaube nicht, dass es was mit dem Spiel zu tun hat.",
    "<SYSTEM>: __orion__ ist jetzt offline",
    "<SYSTEM>: __orion__ ist jetzt online",
    "<ORION>: Hey, hast du versucht /info in den Other world chat zu schreiben?? Es zeigt dir wie lange du online warst",
    "<LIZ>: omg Das ist peinlich....... 849 Stunden",
    "<SYSTEM>: __orion__ ist jetzt offline",
    "<SYSTEM>: __orion__ ist jetzt online",
    "<ORION>: ES HAT FUNKTIONIERT!!! KOMM IN OTHER WORLD, JETZT!!!",
    "<SYSTEM>: __orion__ ist jetzt offline",
    "<SYSTEM>: __orion__ ist jetzt online",
    "<LIZ>: VERLASSE MICH NICHT",
    "<ORION>: Endlich. Ich schmecke fast das Endef",
    "<ORION>: Nein... wo bin ich?",
    "<ORION>: Nur...Dunkelheit...Niemandniemandnie",
    "<LIZ>: SPRICH NIE WIEDER MIT MIR",
    "<SYSTEM>: Du hast __orion__ blokiert",
    "<SYSTEM>: Du hast __orion__ blockiert"
  ],
  "VISUAL_NOVEL_HEY_IS_THIS_LIZ": "Hey, ist das Liz???",
  "VISUAL_NOVEL_YEAH_THIS_IS_LIZ": "yeah..Das ist sie",
  "VISUAL_NOVEL_OH_INTERESTING_SO_STRANGE_TO_SEE_YOU_HERE": "oh interesant... so komisch dich... hier... zu sehen",
  "VISUAL_NOVEL_UM_YEAH_JUST_TOOK_A_LONG_BREAK": "um yeah,ich habe eine lange Pause genommen.",
  "VISUAL_NOVEL_I_DONT_KNOW_WHAT_YOU_MEAN": "i don't know what you mean...",
  "VISUAL_NOVEL_WELL_GLAD_YOURE_BACK_IVE_MISSED_YOU": "Naja. Sschön das du wieder da bist. Ich habe dich vermisst.",
  "VISUAL_NOVEL_IVE_MISSED_YOU_TOO": "Ich habe dich auch vermisst",
  "VISUAL_NOVEL_CAN_YOU_REMIND_ME_WHO_THIS_IS": "Kannst du mir sagen wer das ist?",
  "VISUAL_NOVEL_ITS_ORION_WE_USED_TO_BE_GOOD_FRIENDS_IM_SURPRISED_YOU_DONT_REMEMBER_ME_THATS_FINE": "Ich bins, orion! Wir warren gute Freunde. Ich bin überrascht, dass du dich nicht an mich erinnerst. Ist okay!",
  "VISUAL_NOVEL_ANYTHING_I_CAN_HELP_YOU_WITH": "Irgendetwas mit dem ich dir helfen kann?",
  "VISUAL_NOVEL_DO_YOU_KNOW_THE_PASSCODE_FOR_PHOTOS4EMZIP": "Kennst du das Passwrot für?",
  "VISUAL_NOVEL_HMM_I_DONT_REMEMBER_TRY_DIGGING_THROUGH_YOUR_OLD_CHATLOGS_MAYBE_YOU_SENT_IT_TO_SOMEONE": "hmm... Ich erinnere mich nicht, versuche durch alte Chats zu suchen, vielleicht hast du es zu jemandem geschickt",
  "VISUAL_NOVEL_OKAY_ILL_TRY_THAT_OUT": "okay.. Ich versuchs",
  "VISUAL_NOVEL_WHATS_OTHER_WORLD": "was ist Other World?",
  "VISUAL_NOVEL_YOU_GOTTA_BE_JOKING_YOU_DONT_REMEMBER_ITS_THE_GAME_WE_PLAYED_WHEN_WE_WERE_KIDS_ARE_YOU_SURE_THIS_IS_LIZ": "Du nimmst mich auf den Arm! Du errinerst dich nicht? es ist das Spiel das wir gespielt waren als wir Kinder waren. Bist du sicher, dass das Liz ist?",
  "VISUAL_NOVEL_YES_IM_SURE_HOW_DO_I_GET_IN": "Ja... ich bin mir sicher. Wie komme ich rein?",
  "VISUAL_NOVEL_JUST_TO_MAKE_SURE_YOU_ARE_WHO_YOU_SAY_YOU_ARE_CAN_YOU_TELL_ME_THE_ORDER_OF_THE_FOUR_EVENTS_DURING_OUR_FINAL_RITUAL": "Nur um sicher zu gehen das du du bist... Kannst du mir die Reihenfolge der vier Ereignisse unseres finalen Rituales?",
  "VISUAL_NOVEL_ILL_TRY_TO_REMEMBER": "Ich versuche mich zu errinern",
  "VISUAL_NOVEL_I_DONT_REMEMBER": "Ich errinere mich nicht",
  "VISUAL_NOVEL_THAT_S_OKAY_TAKE_YOUR_TIME": "Das ist okay, nimm dir Zeit",
  "VISUAL_NOVEL_OKAY": "okay",
  "VISUAL_NOVEL_SO_REMIND_ME_WHAT_HAPPENED": "so frische meine Errinerungen auf, was ist passiert?",
  "VISUAL_NOVEL_THAT_MIGHT_BE_RIGHT_THAT_MIGHT_BE_WRONG_WHAT_NEXT": "Das ist eventell richtig eventuell falsch. Was als nächstes?",
  "VISUAL_NOVEL_OK_COULD_BE_WHAT_HAPPENED_BUT_I_WONT_TELL_YOU_WHAT_THEN": "ok... das könnte passiert sein, aber ich werde es dir nicht sagen. Was danach?",
  "VISUAL_NOVEL_AND_FINALLY": "und letztendlich?",
  "VISUAL_NOVEL_WE_BLESSED_THE_STATUE": "Wir segneten die Statuee",
  "VISUAL_NOVEL_WE_LIT_CANDLES_FOR_OUR_TRIBUTES": "Wir entzündeten Kerzen für unsere Würdigen",
  "VISUAL_NOVEL_WE_GAZED_UPON_THE_FOUNTAIN": "Wir blickten auf den Brunnen",
  "VISUAL_NOVEL_WE_FOUGHT_THE_LOST_BOYS": "Wir bekämpften die verlohrenen Jungen",
  ...
  "NOTES": [
    ...
    "8/25 photos from my digi cam just came in!!!! sooOoo xcited >.<",
  ...
  "ENDING_I_MISS_OUR_STUPID_FIGHTS": "<system> our fights seem so far away now",
  "ENDING_ITS_ALL_SO_MEANINGLESS_NOW": "<system> its all so meaningless. if i could have realized how temporary it all was.",
  ...
  "OTHER_WORLD_DOOR_PUZZLE_SOMETHING_IN_DOOR_CHANGES": "<system> Something in the door changes... You've done something, or part of something...",
  "OTHER_WORLD_DOOR_PUZZLE_SOLVED": "<system> The door unlocks.",

  // June 24
  "ORION_IS_TYPING": "__orion__ is typing...",
  "SCROLL_TO_TOP": "Scroll to Top",
  "SERVERS_EMPTY": "EMPTY",
  "SERVERS_UPLOAD": "click here to upload world",
  "SERVERS_USER_WORLD": "<user world>",
  "SERVERS_HOUSE_OF_BAPHOMET_LINE_1": "house of",
  "SERVERS_HOUSE_OF_BAPHOMET_LINE_2": "baphomet",

  "TRIBUTES_BOND_LINE_1": "whose bond",
  "TRIBUTES_BOND_LINE_2": "do you trust",
  "TRIBUTES_BOND_LINE_3": "the most?",

  "TRIBUTES_UNREQUITED_LINE_1": "who is your",
  "TRIBUTES_UNREQUITED_LINE_2": "unrequited",
  "TRIBUTES_UNREQUITED_LINE_3": "desire?",

  "TRIBUTES_FATE_LINE_1": "who is the",
  "TRIBUTES_FATE_LINE_2": "sole controller",
  "TRIBUTES_FATE_LINE_3": "of your fate?",

  // June 27
  "VIDEO_CALL_INCOMING_CALL": "Incoming Call",
  "CONSCIOUSNESS_TRIANGULATION": "Consciousness Triangulation",
  "ENDING_POPUP_OFFLINE": "Offline",
  ...
  "SETTINGS_DELETE_SAVE": "Restart from the Beginning",
  "SETTINGS_QUIT_GAME": "Quit Game",

  "OTHER_WORLD_CANDLES": "<system> Three candles... But how to light them?",
  "OTHER_WORLD_DOOR_PUZZLE_FRAME_KNOCK": "<system> The door is too thick to make any decent sound with your hands. Perhaps you can use the door knockers.",

  // Mar 19, 2025
  "ENDING_UPLOADING_WEBCAM": "<system> Uploading... \"__orion__WEBCAM_CAPTURE.mp4\"",

  // May 12, 2025
  "WARNING": "WARNING",
  "TRIGGER_WARNING": "This is a psychological horror game and is not suitable for children or those who are easily disturbed.",
